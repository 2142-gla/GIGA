...
"""
gigaConvert takes data from the GIGA.pl Perl program and puts it in data frames that can be used to make 
graph files that can be visualised on network visualisation software.
Robin Shaw
June 2017
"""
# Packages
...
#   Checks the dictionaries to make sure the anchor genes are correct
#   Input: None
#   Output: None
def checkDictionaries():
    # Get the gene at postion one of each subgraph and compare it to the anchor gene
    for title in funClasses:
        # If there is a conflict replace the false information with the information for postion one gene
        if funClasses[title][2][0][0] != title:
