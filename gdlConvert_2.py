"""
Conversion program for the gdl graph format
Converts into the gml format
"""
...
for key in funClasses:
    # Print top of graph
    label = key + " " + funClasses[key][0]
    print (label)
    print ((graphTop)%(label))
    newFile.write((graphTop) % (label))
    # Print nodes
